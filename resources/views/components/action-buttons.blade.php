...
<div class="flex justify-center space-x-3" x-data="{ showDeleteModal: false }">
    ...
    <button @click="showDeleteModal = true"
        class="text-red-600 hover:text-red-900 transition-colors duration-200 focus:outline-none">
        <i class="fas fa-trash-alt"></i>
    </button>

    <!-- Delete Confirmation Modal -->
    <div x-show="showDeleteModal" x-cloak x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
