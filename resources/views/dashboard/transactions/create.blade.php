            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" x-data="{
                ...
                filteredCustomers() {
                    ...
                    return this.customers.filter(c =>
                        ...
                        c.vehicle_plate.toLowerCase().includes(this.search.toLowerCase()));
                },
                updatePrice() {
                ...
                {{-- Select Customer - Improved Version --}}
                <div class="col-span-1 sm:col-span-2 p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <input type="hidden" id="customer_id" name="customer_id" x-ref="hiddenCustomerInput" required />
